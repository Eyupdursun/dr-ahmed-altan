...
export default function CustomerReviews() {
    ...
    const cardsX = useTransform(springProgress, [0.2, 0.8], ["10%", "-60%"]);
    ...
    return (
        <section
            ref={containerRef}
            className="relative h-[250vh] bg-[var(--color-bg)] w-full"
        >
            <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center">
                ...
                <div className="w-full pl-6 md:pl-16 lg:pl-24 mb-16 md:mb-24">
                    <motion.div
                    ...
                    >
                        ...
                        <h2
                            className="text-[clamp(2.5rem,5vw,4.5rem)] font-medium leading-[1.04] text-[var(--color-fg-bone)] tracking-[-0.02em] max-w-[20ch]"
                ...
                <div className="relative w-full">
                    <motion.div
                        className="flex gap-6 md:gap-12 px-6 md:px-16 lg:px-24 w-max"
                        style={{ x: cardsX }}
                    >
                        {REVIEWS.map((review, i) => (
                            <div
                                key={review.id}
                                className="w-[85vw] md:w-[600px] lg:w-[700px] min-h-[400px] shrink-0 rounded-[40px] border border-[var(--color-border-soft)] bg-[#111814]/80 backdrop-blur-xl relative overflow-hidden group flex flex-col justify-center"
                            >
                                ...
                                <div className="relative z-10 w-full h-full box-border px-8 py-12 md:px-14 md:py-16 lg:px-20 lg:py-20 flex flex-col justify-center gap-8 md:gap-10">
